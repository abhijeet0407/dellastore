...
if ( ! function_exists( 'cstmfldssrch_add_to_admin_menu' ) ) {
	function cstmfldssrch_add_to_admin_menu() {
		bws_general_menu();
		$hook = add_submenu_page( 'bws_panel', __( 'Custom Fields Search settings', 'custom-fields-search' ), 'Custom Fields Search', 'manage_options', "custom-fields-search.php", 'cstmfldssrch_page_of_settings' );

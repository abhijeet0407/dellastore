<?php
	if( !class_exists( 'Arexworks_Widget_Base' ) ){
		abstract class Arexworks_Widget_Base extends WP_Widget {
			...
			public function get_cached_widget( $args ) {
				...
				$cache = wp_cache_get( apply_filters( 'arexworks_filter_cached_widget_id', $this->widget_id ), 'widget' );
			...
			public function cache_widget( $args, $content ) {
				wp_cache_set( apply_filters( 'arexworks_filter_cached_widget_id', $this->widget_id ), array( $args['widget_id'] => $content ), 'widget' );
			...
			public function flush_widget_cache() {
				wp_cache_delete( apply_filters( 'arexworks_filter_cached_widget_id', $this->widget_id ), 'widget' );
			}

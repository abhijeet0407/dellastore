...
(function($) {
    ...
    $.redux.wbc_importer = function() {
        ...
        $('.wrap-importer.theme.not-imported, #wbc-importer-reimport').unbind('click').on('click', function(e) {
            ...
            if(parent.is('.not-imported') && $(e.target).closest('.theme-extra-options').length){
                e.stopPropagation();
            }else{
            ...
            data.without_content = parent.find('input.extra-import-options').is(':checked') ? '1' : '';
            ...
            jQuery.post(
                ...
                alert( "There was an error importing demo content ! Please refresh this page" );
            });
            return false;
